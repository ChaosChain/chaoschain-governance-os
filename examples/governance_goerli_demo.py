#!/usr/bin/env python3
"""
Governance Analysis Goerli Demo

This script demonstrates the governance analysis functionality
using real Goerli testnet data with the option to anchor results on-chain.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Governance Analysis Goerli Demo')
    ...
    parser.add_argument(
        ...
        help='Ethereum testnet to use (default: goerli)'
    )
...
def main():
    """Run the governance analysis demo on Goerli testnet."""
    args = parse_args()
    ...
    logger.info("Starting Governance Analysis Goerli Demo")
    ...
    # Fetch proposals
    logger.info("Fetching governance proposals from Goerli testnet...")
