...
This module implements a CrewAI crew for blockchain governance,
...
from agent.crew.researcher.gas_metrics_researcher import GasMetricsResearcher
from agent.crew.developer.parameter_optimizer import ParameterOptimizer


class GovernanceCrew:
    """
    A CrewAI crew for blockchain governance, combining researcher and developer agents
    to generate parameter optimization proposals.
    """
    
    def __init__(self, llm=None, verbose=False):
        """
        Initialize the governance crew.
    ...
    def _create_tasks(self) -> list:
        """
        Create the tasks for the governance crew.
    ...
    def run(self) -> Dict[str, Any]:
        """
        Run the governance crew workflow.
